...
export const ACTIVITY_TYPES: ActivityType[] = [
  // Meta Ads
  {
    ...
    fields: [
      ...
      { key: "idade", label: "Faixa Etária", type: "select", options: [
        ...
        { value: "18-65+", label: "Todas as idades (18-65+)" },
      ]},
      { key: "genero", label: "Gênero", type: "select", options: [
        { value: "todos", label: "Todos" },
        { value: "masculino", label: "Masculino" },
        { value: "feminino", label: "Feminino" },
      ]},
      { key: "descricao", label: "Descrição / Observações", type: "textarea", placeholder: "Detalhes adicionais da campanha" },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "descricao", label: "Descrição", type: "textarea", placeholder: "Detalhes da otimização" },
    ],

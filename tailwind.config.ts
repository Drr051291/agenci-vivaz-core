  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'md': 'var(--shadow-md)',
        'lg': 'var(--shadow-lg)',
        'card': '0 1px 3px 0 hsl(220 14% 10% / 0.04), 0 1px 2px -1px hsl(220 14% 10% / 0.04)',
        'card-hover': '0 8px 16px -4px hsl(220 14% 10% / 0.08), 0 4px 6px -4px hsl(220 14% 10% / 0.04)',
        'glow': '0 0 20px hsl(270 70% 55% / 0.15)',
        'glow-lg': '0 0 40px hsl(270 70% 55% / 0.2)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
